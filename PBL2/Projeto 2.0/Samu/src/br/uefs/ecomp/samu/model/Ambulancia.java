...
public class Ambulancia
{
	...
	/**
	 * Esse metodo é usado para fazer a verificação do atributo placa da classe Ambulancia
	...
	/**
	 * Esse metodo é usado para fazer a modificação do atributo placa da classe Ambulancia
