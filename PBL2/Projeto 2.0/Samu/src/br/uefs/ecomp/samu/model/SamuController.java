...
public class SamuController
{
	...
	/**
	 * Método responsável por ordena os cidadões.
	 * @return iterador
	 */
	...
	/**
	 * Método que cadastra o Antendente.
	 * @param cpf-String
	 * @param nome-String
	 * @param endereco-String
	...
	/**
	 * Método que lista o atendentes em ordenado
	 * @return iterador 
	 */
	...
	/**
	 * Método lista ambulancias em ordenado
	 * @return
	 */
